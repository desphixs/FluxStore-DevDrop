    ...
    return (function () {
        ...
        var t = {
                ...
                853: function (t, e, i) {
                    ...
                    var kt = {
                        ...
                        fn: function (t) {
                            var e = t.state,
                                ...
                                l = wt(d),
                                u = wt(c);
                            (e.modifiersData[i] = { referenceClippingOffsets: d, popperEscapeOffsets: c, isReferenceHidden: l, hasPopperEscaped: u }), (e.attributes.popper = Object.assign({}, e.attributes.popper, { "data-popper-reference-hidden": l, "data-popper-escaped": u }));
                        },
                    };
                    var Et = {
                        name: "offset",
                    ...
                    function Ot(t, e, i) {
                        ...
                        var n,
                            ...
                            l = { x: 0, y: 0 };
                        return (o || (!o && !i)) && (("body" !== L(e) || ut(s)) && (c = (n = e) !== I(n) && C(n) ? { scrollLeft: (r = n).scrollLeft, scrollTop: r.scrollTop } : ct(n)), C(e) ? (((l = z(e, !0)).x += e.clientLeft), (l.y += e.clientTop)) : s && (l.x = lt(s))), { x: d.left + c.scrollLeft - l.x, y: d.top + c.scrollTop - l.y, width: d.width, height: d.height };
                    }
                    function Lt(t) {
                        var e = new Map(),
                            i = new Set(),
                ...
                554: function (t, e) {
                    ...
                    function ft(t, e) {
                        ...
                        if (n.language && (n.language !== d && (o[n.language] ? (i = n.language) : void 0 === o[(i = n.language.split("-")[0])] && (i = !1)), delete n.language, i)) {
                            d = r.language = i;
                            var v = c || o[st];
                            (c = Object.assign({ format: dt, weekStart: ct }, o[st])), d !== st && Object.assign(c, o[d]), (r.locale = c), s === v.format && (s = r.format = c.format), g === v.weekStart && ((g = r.weekStart = c.weekStart), (r.weekEnd = ut(c.weekStart)));
                        }
                        if (n.format) {
                                        ...
                                        value: function () {
                                            ...
                                            Array.from(this.grid.children).forEach(function (e, i) {
                                                var n = e.classList,
                                                    ...
                                                    a = o.getDay();
                                                if (
                                                    ((e.className = "datepicker-cell hover:bg-gray-100 dark:hover:bg-gray-600 block flex-1 leading-9 border-0 rounded-lg cursor-pointer text-center text-gray-900 dark:text-white font-semibold text-sm ".concat(t.cellClass)),
                                                    (e.dataset.date = r),
                                                    ...
                                                    (r < t.minDate || r > t.maxDate || t.disabled.includes(r)) && (n.add("disabled", "cursor-not-allowed", "text-gray-400", "dark:text-gray-500"), n.remove("hover:bg-gray-100", "dark:hover:bg-gray-600", "text-gray-900", "dark:text-white", "cursor-pointer")),
                                                    t.daysOfWeekDisabled.includes(a) && (n.add("disabled", "cursor-not-allowed", "text-gray-400", "dark:text-gray-500"), n.remove("hover:bg-gray-100", "dark:hover:bg-gray-600", "text-gray-900", "dark:text-white", "cursor-pointer"), _(t.disabled, r)),
                ...
                33: function (t, e, i) {
                    ...
                    var r = i(423),
                        o = { defaultPosition: 0, indicators: { items: [], activeClasses: "bg-white dark:bg-gray-800", inactiveClasses: "bg-white/50 dark:bg-gray-800/50 hover:bg-white dark:hover:bg-gray-800" }, interval: 3e3, onNext: function () {}, onPrev: function () {}, onChange: function () {} },
                        a = { id: null, override: !0 },
                        s = (function () {
                            function t(t, e, i, s) {
                ...
                673: function (t, e, i) {
                    ...
                    function d() {
                        document.querySelectorAll("[data-copy-to-clipboard-target]").forEach(function (t) {
                            ...
                            i ? r.default.instanceExists("CopyClipboard", i.getAttribute("id")) || new s(t, i, { htmlEntities: !(!a || "true" !== a) || o.htmlEntities, contentType: n || o.contentType }) : console.error('The target element with id "'.concat(e, '" does not exist. Please check the data-copy-to-clipboard-target attribute.'));
                        });
                    }
                ...
                132: function (t, e, i) {
                    ...
                    var r = i(423),
                        o = i(554),
                        a = { defaultDatepickerId: null, autohide: !1, format: "mm/dd/yyyy", maxDate: null, minDate: null, orientation: "bottom", buttons: !1, autoSelectToday: 0, title: null, language: "en", rangePicker: !1, onShow: function () {}, onHide: function () {} },
                    ...
                    function c() {
                        document.querySelectorAll("[datepicker], [inline-datepicker], [date-rangepicker]").forEach(function (t) {
                            if (t) {
                                ...
                                new d(t, { buttons: e || a.buttons, autoSelectToday: i || a.autoSelectToday, autohide: n || a.autohide, format: r || a.format, maxDate: o || a.maxDate, minDate: s || a.minDate, orientation: c || a.orientation, title: l || a.title, language: u || a.language, rangePicker: h || a.rangePicker });
                ...
                340: function (t, e, i) {
                    ...
                    var r = i(423),
                        o = { placement: "left", bodyScrolling: !1, backdrop: !0, edge: !1, edgeOffset: "bottom-[60px]", backdropClasses: "bg-gray-900/50 dark:bg-gray-900/80 fixed inset-0 z-30", onShow: function () {}, onHide: function () {}, onToggle: function () {} },
                        a = { id: null, override: !0 },
                        s = (function () {
                            function t(t, e, i) {
                    ...
                    function l() {
                        document.querySelectorAll("[data-dropdown-toggle]").forEach(function (t) {
                            ...
                            if (i) {
                                ...
                                new c(i, t, { placement: n || s.placement, triggerType: a || s.triggerType, offsetSkidding: r ? parseInt(r) : s.offsetSkidding, offsetDistance: o ? parseInt(o) : s.offsetDistance, delay: d ? parseInt(d) : s.delay, ignoreClickOutsideClass: l || s.ignoreClickOutsideClass });
                ...
                656: function (t, e, i) {
                    ...
                    function d() {
                        document.querySelectorAll("[data-input-counter]").forEach(function (t) {
                            ...
                            t ? r.default.instanceExists("InputCounter", t.getAttribute("id")) || new s(t, i || null, n || null, { minValue: o ? parseInt(o) : null, maxValue: a ? parseInt(a) : null }) : console.error('The target element with id "'.concat(e, '" does not exist. Please check the data-input-counter attribute.'));
                        });
                    }
